...
Кроме оценки на 4 уровнях используется ещё один подход.
...
Оценочные элементы - числовые элементы.
...
Он **устанавливает** основу для аттестации зрелости процессов жизненного цикла ПС. Эта основа может быть использована организациями, занимающимися планированием, управлением, наблюдением, контролем и совершенствованием приобретения, поставки, разработки, эксплуатации и поддержки ПС.
 ...
 15504-2 описывает набор универсальных процессов, которые являются фундаментальными для программной инженерии. Эта часть **определяет** эталонную модель процессов и их зрелости, которая формирует базис для любой модели применяемой для аттестации процессов.
...
2. 1 уровень - Выполняемый процесс, определен объем работ и перечень продуктов, будут получены продукты.
3. 2 уровень - Управляемый процесс, определены целевые показатели (качество, время, ресурсы и др.); распределение ответственности между персоналом; управление процессом для получения продуктов удовлетворяющих определенным требованиям. Управление рабочими продуктами: определены требования к продуктам процесса; верификация продуктов, для соответствия заданным требованиям.
4. 3 уровень - Устоявшийся процесс, Задание процесса: определяет стандартный процесс; собирает исторические данные; опыт применяется для уточнения стандартного процесса. Обеспечение процесса ресурсами: идентифицированны и документированы роли, ответственности и навыки, инфраструктура; ресурсы будут обеспечены, распределены и использованы.
...
Каждый уровень является очередным шагом в развитии процесса, мера зрелости основывается на наборе атрибутов процессов. Атрибуты оцениваются в процентах, что дает дополнительное понимание конкретных аспектов зрелости процессов.
